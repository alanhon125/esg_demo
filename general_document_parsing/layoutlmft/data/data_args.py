...
class DataTrainingArguments:
    ...
    doc_layout_split_test: bool = field(default=False)
    pred_dataset: str = field(
        default='test', metadata={"help": "Selection of dataset for prediction (train, validation, test). Default to 'test'."})
