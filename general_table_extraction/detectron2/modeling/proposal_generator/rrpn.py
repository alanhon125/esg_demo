...
from general_table_extraction.detectron2.layers import ShapeSpec, batched_nms_rotated, cat
from general_table_extraction.detectron2.structures import Instances, RotatedBoxes, pairwise_iou_rotated
