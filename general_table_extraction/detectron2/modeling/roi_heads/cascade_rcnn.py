...
from general_table_extraction.detectron2.layers import ShapeSpec
from general_table_extraction.detectron2.structures import Boxes, Instances, pairwise_iou
