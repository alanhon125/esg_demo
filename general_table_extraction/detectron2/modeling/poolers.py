...
from general_table_extraction.detectron2.layers import ROIAlign, ROIAlignRotated, cat, nonzero_tuple, shapes_to_tensor
from general_table_extraction.detectron2.structures import Boxes
