...
from general_table_extraction.detectron2.layers import ShapeSpec, batched_nms
from general_table_extraction.detectron2.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
