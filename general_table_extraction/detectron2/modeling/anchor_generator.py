...
from general_table_extraction.detectron2.layers import ShapeSpec, move_device_like
from general_table_extraction.detectron2.structures import Boxes, RotatedBoxes
